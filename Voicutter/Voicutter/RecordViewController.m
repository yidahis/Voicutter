...
- (IBAction)popBack:(id)sender {
    ...
    NSLog(@"relativeString: %@",[self testFilePath]);
    
    [[NSNotificationCenter defaultCenter]postNotificationName:kRecordFinsh object:[NSString stringWithFormat:@"%@",[self testFilePath]]];
